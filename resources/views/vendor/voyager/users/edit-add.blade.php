                ...
                <div class="col-md-8">
                    <div class="panel panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="slug">{{ __('generic.slug') }}</label>
                                <input type="text" class="form-control" id="slug" name="slug" data-slug-origin="name"
                                       placeholder="{{ __('generic.slug') }}"
                                       value="@if(isset($dataTypeContent->name)){{ $dataTypeContent->name }}@endif">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info generate-password">Generate password</button>
                            </div>
